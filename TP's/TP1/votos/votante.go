...
type Votante interface {
	...
	//deshacer, devolverá 0. En caso de no haber acción para deshacer, devolverá -1.
	//También puede devolver -2 en caso que el votante ya hubiera terminado antes su proceso de votación.
	Deshacer() error
